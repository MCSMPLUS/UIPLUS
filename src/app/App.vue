...
<template>
  <el-container>
    ...
    <!-- 管理用户 电脑屏幕菜单栏 -->
    <div v-if="isTopPermission" class="only-pc-display" id="app-menu">
      <el-aside width="240px" style="height: 100%">
        <Aside />
      </el-aside>
    </div>
    <el-container>
      <el-header class="app-header-container">
        <Header style="z-index: 1000" :breadcrumbsList="breadCrumbs" :aside="toAside" />
      </el-header>
